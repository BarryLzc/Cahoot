...
type IUserDo interface {
	...
	WriteRouteOnly() IUserDo
	SetSqlKey(sqlKey string) IUserDo
...
func (u userDo) WriteRouteOnly() IUserDo {
	return u.withDO(u.DO.WriteRouteOnly())
}

func (u userDo) SetSqlKey(sqlKey string) IUserDo {
	return u.withDO(u.DO.SetSqlKey(sqlKey))
}
